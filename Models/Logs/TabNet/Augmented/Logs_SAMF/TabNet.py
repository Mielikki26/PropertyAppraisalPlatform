...
with two new features - Country and Province.
...
json_file = 'resultsTabnet_SAMF.json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_SAMF\\" #files_directory
...
#directories
cur_dir = os.getcwd()
datasets_dir = str(cur_dir) + r'\Augmented_SA_datasets\\'
datasets_list = os.listdir(str(cur_dir) + r'\Augmented_SA_datasets\\')
...
print("In this script only the South American datasets are used and they have two extra features - Country and Province"
