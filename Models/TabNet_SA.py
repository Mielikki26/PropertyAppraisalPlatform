...
This script trains a TabNet model on the South American datasets
with seven new features - Country, Province, City, 
TotalArea, Rooms, PropertyType, OperationType.
...
json_file = 'resultsTabnet_SAMF_2.json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_SAMF_2\\" #files_directory
...
continuos_features = ["Area", "Baths", "Beds", "Latitude", "Longitude", "Month", "Year", "Rooms", "TotalArea"]
categorical_features = ["Country", "Province", "City", "PropertyType", "OperationType"]
labels = ["Price"]

#directories
cur_dir = os.getcwd()
datasets_dir = str(cur_dir) + r'\Augmented_SA_datasets_2\\'
datasets_list = os.listdir(str(cur_dir) + r'\Augmented_SA_datasets_2\\')
...
print("In this script only the South American datasets are used and they have seven "
      "new features - Country, Province, City, TotalArea, Rooms, PropertyType, OperationType."
      "This is done to test the possibility that the number of features being used is "
      "too low and adding more is helpful")
