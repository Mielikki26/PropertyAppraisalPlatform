...
This script trains a TabNet model on the above 10% augmented COEFICIENT datasets.
...
json_file = 'resultsTabnet_geopy_Above10%_coeficient.json' #json file name
fd = r"\Logs\TabNet\10x\Augmented\Above10%_coeficient\Logs\\" #files_directory
...
def trainxtimes(X_continuos, X_categorical, Y, filename, nr_iter):
    """
    ...
    :param nr_iter: number of times to train the dataset
