...
by testing the Melbourne dataset with 5 new features
...
json_file = 'resultsTabnet_MF_Melbourne.json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_MF_Melbourne\\" #files_directory
...
print("In this script only the Melbourne dataset is used and its a continuation of the augmentation tests"
      "Here the test done is to test the improvement that the new 5 features provide")
