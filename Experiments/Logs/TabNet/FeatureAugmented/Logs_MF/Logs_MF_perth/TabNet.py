...
by testing the perth dataset with 8 new features
...
json_file = 'resultsTabnet_MF_perth.json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_MF_perth\\" #files_directory
...
continuos_features = ["Area", "Baths", "Beds", "Latitude", "Longitude", "Month", "Year",
                      "GARAGE", "LAND_AREA", "BUILD_YEAR", "CBD_DIST", "NEAREST_STN_DIST", "POSTCODE", "NEAREST_SCH_DIST"]
...
print("In this script only the perth dataset is used and its a continuation of the augmentation tests"
      "Here the test done is to test the improvement that the new 8 features provide")
...
mapes, r2s, maes = trainxtimes(X_continuos, X_categorical, Y, dataset, 10)
