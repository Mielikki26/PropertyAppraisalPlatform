...
by adding 2 new features that should be obtainable from these 2 - Country and Province
...
json_file = 'resultsTabnet_SAMF(lat and lon test).json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_SAMF(lat and lon test)\\" #files_directory
