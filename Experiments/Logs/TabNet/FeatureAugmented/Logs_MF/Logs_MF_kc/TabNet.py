...
by testing the kc house data dataset with 10 new features
...
json_file = 'resultsTabnet_MF_kc.json' #json file name
fd = r"\Logs\TabNet\Augmented\Logs_MF_kc\\" #files_directory
...
print("In this script only the kc house data dataset is used and its a continuation of the augmentation tests"
      "Here the test done is to test the improvement that the new 10 features provide")
