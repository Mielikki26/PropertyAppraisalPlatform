...
json_file = 'resultsTabnet_Min25.json' #json file name
fd = r"\Logs\TabNet\5x\SSNormalization\Logs_Min25\\" #files_directory
...
for filename in datasets_list:
    ...
    if df.shape[0] > min_shape*2:
        remove_n_rows = int(df.shape[0]/4)
