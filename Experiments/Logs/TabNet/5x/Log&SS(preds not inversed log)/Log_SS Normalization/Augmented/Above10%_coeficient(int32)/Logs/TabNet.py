...
fd = r"\Logs\TabNet\5x\Log_SS Normalization\Augmented\Above10%_coeficient(int32)\Logs\\" #files_directory
...
def trainxtimes(X_continuos, X_categorical, Y, filename, nr_iter):
    ...
    for i in range(nr_iter):
        ...
        x_test_continuos_log = scalerx.inverse_transform(x_test_norm[:,0:7])
        x_test_continuos = np.expm1(x_test_continuos_log[:, 0:7])
