...
json_file = 'resultsTabnet_SA.json' #json file name
fd = r"\Logs\TabNet\SSNormalization\Logs_SA\\" #files_directory
...
print("In this script only the South American datasets are used so the results can be compared "
      "to the experience using data augmentation")
