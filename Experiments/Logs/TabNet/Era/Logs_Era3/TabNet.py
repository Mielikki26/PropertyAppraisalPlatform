...
json_file = 'resultsTabnet_Era3.json' #json file name
fd = r"\Logs\TabNet\Era\Logs_Era3\\" #files_directory
...
mapes, r2s, maes = trainxtimes(X_continuos, X_categorical, Y, datasets, 10)
