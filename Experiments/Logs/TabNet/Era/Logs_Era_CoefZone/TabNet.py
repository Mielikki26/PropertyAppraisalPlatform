...
This script trains a TabNet model on the Era dataset using CoefZone
...
json_file = 'resultsTabnet_Era_CoefZone.json' #json file name
fd = r"\Logs\TabNet\Era\Logs_Era_CoefZone\\" #files_directory
