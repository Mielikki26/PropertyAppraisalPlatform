...
This script trains a TabNet model on the Era dataset using CoefParish
...
json_file = 'resultsTabnet_Era_CoefParish.json' #json file name
fd = r"\Logs\TabNet\Era\Logs_Era_CoefParish\\" #files_directory
...
#directories
cur_dir = os.getcwd()
datasets_dir = str(cur_dir) + r'\Era_dataset\Coeficientes\FloorArea\\'
datasets_list = os.listdir(str(cur_dir) + r'\Era_dataset\Coeficientes\FloorArea\\')

#datasets to use
datasets = "Era_Coef_FloorArea.csv"
