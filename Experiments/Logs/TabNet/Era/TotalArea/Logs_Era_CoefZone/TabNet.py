...
This script trains a TabNet model on the Era dataset using CoefZone with TotalArea
...
json_file = 'resultsTabnet_Era_CoefZone_TotalArea.json' #json file name
fd = r"\Logs\TabNet\Era\TotalArea\Logs_Era_CoefZone\\" #files_directory
