...
This script trains a TabNet model on the Era dataset using CoefParish with TotalArea
...
json_file = 'resultsTabnet_Era_CoefParish_TotalArea.json' #json file name
fd = r"\Logs\TabNet\Era\TotalArea\Logs_Era_CoefParish\\" #files_directory
...
#directories
cur_dir = os.getcwd()
datasets_dir = str(cur_dir) + r'\Era_dataset\Coeficientes\TotalArea\\'
datasets_list = os.listdir(str(cur_dir) + r'\Era_dataset\Coeficientes\TotalArea\\')

#datasets to use
datasets = "Era_Coef_TotalArea.csv"
