...
This script trains a TabNet model on the Era dataset using CoefParish(NoND)
...
json_file = 'resultsTabnet_Era_CoefParish_NoND.json' #json file name
fd = r"\Logs\TabNet\Era\Logs_Era_CoefParish_NoND\\" #files_directory
