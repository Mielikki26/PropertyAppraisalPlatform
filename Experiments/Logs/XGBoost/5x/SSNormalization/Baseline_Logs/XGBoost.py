...
fd = r"\Logs\XGBoost\5x\SSNormalization\Baseline_Logs\\" #files_directory
...
tabnet_data = {'model': "XGBoost", 'datasets': datasets, 'avg_mape': avg_mape, 'avg_r2': avg_r2, 'avg_mae': avg_mae}
