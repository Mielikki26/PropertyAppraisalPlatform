...
fd = r"\Logs\MLPR\5x\SSNormalization\Baseline_Logs\\" #files_directory
...
#directories
cur_dir = os.getcwd()
datasets_dir = str(cur_dir) + r'\Baseline_datasets\\'
datasets_list = os.listdir(str(cur_dir) + r'\Baseline_datasets\\')

#datasets to use
datasets = ["all perth.csv" ,"ar properties.csv", "co properties.csv", "DC Properties.csv", "kc house data.csv",
            "Melbourne housing.csv", "pe properties.csv", "uy properties.csv", "Zameen Data.csv"]
