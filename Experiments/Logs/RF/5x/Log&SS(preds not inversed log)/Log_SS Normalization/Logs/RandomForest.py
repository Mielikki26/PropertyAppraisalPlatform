...
fd = r"\Logs\RF\5x\Log_SS Normalization\Logs\\" #files_directory
...
def trainxtimes(X, Y, filename,x):
    ...
    for i in range(x):
        ...
        x_train_log, x_test_log, y_train_log, y_test_log = train_test_split(X_log, Y_log, train_size=0.7, test_size=0.3,
                                                                            random_state=i)
