#script used to calculate the correct values of mape, r2 and mae for the Coefficient experiments
#it basically opens the prediction csvs saved by the training scripts and opens the original csvs used in those experiments
#then it uses both to calculate the true Price predicted by the model and calculates the metrics
